...
export function CartPage() {
  ...
  if (items.length === 0) {
    return (
      <main className="mx-auto max-w-7xl px-4 py-20 text-center sm:px-6 lg:px-8">
        ...
        <h1 className="mt-4 text-2xl font-bold text-stone-900">Your pack is empty</h1>
        <p className="mt-2 text-stone-500">Add some gear to get started.</p>
        <Link to="/">
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <h1 className="mb-8 text-3xl font-extrabold text-stone-900">Your Pack</h1>
            ...
            >
              ...
              <div className="flex flex-1 flex-col gap-1">
                <Link to={`/products/${product.id}`}>
                  <h3 className="font-bold text-stone-900 hover:text-amber-700 transition-colors">
                    {product.name}
                  </h3>
                </Link>
                ...
                <div className="mt-auto flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="flex h-7 w-7 items-center justify-center rounded-md border border-stone-300 text-stone-600 hover:border-amber-400 hover:text-amber-700 transition-colors"
        ...
        <aside className="rounded-2xl border border-stone-200 bg-white p-6 shadow-sm h-fit sticky top-24">
          ...
          <dl className="space-y-2 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <dd className={shippingCost === 0 ? 'font-medium text-emerald-600' : 'font-medium'}>
          ...
          {subtotal < SHIPPING_THRESHOLD && (
            <p className="mt-4 rounded-lg bg-amber-50 px-3 py-2 text-xs text-amber-800 border border-amber-200">
          ...
          <Link to="/" className="mt-3 block text-center text-sm text-amber-600 hover:text-amber-800">
            Continue Shopping
          </Link>
        </aside>
      </div>
